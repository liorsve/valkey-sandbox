    ...
    <div class="coding-challenges">
        <div class="challenge-sidebar">
            <ul class="challenge-list">
                <li v-for="challenge in availableChallenges" :key="challenge.id" @click="selectChallenge(challenge)"
            ...
            <div v-if="selectedChallenge" class="challenge-info">
                ...
                <div v-if="selectedChallenge.description" class="markdown" v-html="sanitizedDescription"></div>
                ...
                <button @click="toggleHints" class="hint-btn">{{ showHints ? 'Hide' : 'Show' }} Hints</button>
        ...
        <div class="challenge-workspace">
            <div class="editor-terminal">
                <CodeEditor v-model:modelValue="userCode" :language="selectedLanguage" class="challenge-editor"
...
export default defineComponent( {
    ...
    methods: {
        selectChallenge( challenge ) {
            this.selectedChallenge = ChallengeManager.getChallenge( challenge.id, this.selectedLanguage );
