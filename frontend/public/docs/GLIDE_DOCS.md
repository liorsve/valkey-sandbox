...
- [zrevrank](#zrevrank)
- [zrevrankWithScore](#zrevrankwithscore)
- [persist](#persist)
...
- [copy](#copy)
- [lolwut](#lolwut)
- [fcallWithRoute](#fcallwithroute)
- [fcallReadonlyWithRoute](#fcallreadonlywithroute)
- [functionDelete](#functiondelete)
- [functionLoad](#functionload)
- [functionFlush](#functionflush)
- [functionList](#functionlist)
...
- [randomKey](#randomkey)
- [unwatch](#unwatch)
- [invokeScriptWithRoute](#invokescriptwithroute)
- [scriptExists](#scriptexists)
- [scriptFlush](#scriptflush)
- [scriptKill](#scriptkill)
...
- [cancelPubSubFuturesWithExceptionSafe](#cancelpubsubfutureswithexceptionsafe)
- [isPubsubConfigured](#ispubsubconfigured)
- [getPubsubCallbackAndContext](#getpubsubcallbackandcontext)
- [getPubSubMessage](#getpubsubmessage)
- [tryGetPubSubMessage](#trygetpubsubmessage)
- [notificationToPubSubMessageSafe](#notificationtopubsubmessagesafe)
- [completePubSubFuturesSafe](#completepubsubfuturessafe)
- [get](#get)
- [getex](#getex)
- [getdel](#getdel)
- [getrange](#getrange)
...
- [BitOverflowControl](#bitoverflowcontrol)
- [ListDirection](#listdirection)
- [ExpireOptions](#expireoptions)
- [UpdateByScore](#updatebyscore)
- [InfBoundary](#infboundary)
- [InsertPosition](#insertposition)
- [FunctionRestorePolicy](#functionrestorepolicy)
